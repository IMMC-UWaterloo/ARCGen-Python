...
charAvg, innCorr, outCorr, processed, debug = arcgen(
    inputSignals, nResamplePoints=500, CorridorRes=500, nWarpCtrlPts=2
)
...
# Load data itself
rawCsv = np.genfromtxt(inputPath, delimiter=",", skip_header=1, encoding=None)
nSignals = rawCsv.shape[1] / 2
inputSignals = []
...
charAvg, innCorr, outCorr, processed, debug = arcgen(
    inputSignals, nResamplePoints=500, CorridorRes=500, nWarpCtrlPts=3
)
